...
vision-mark   ::= "{" ws
                    "\\"type\\"" ws ":" ws "\\"vision\\"" ws "," ws
                    "\\"subtype\\"" ws ":" ws "\\"" vision-subtype "\\"" ws "," ws
                    "\\"note\\"" ws ":" ws string
                  ws "}"
vision-subtype ::= "goal" | "direction" | "principle"
choice-mark   ::= "{" ws
                    "\\"type\\"" ws ":" ws "\\"choice\\"" ws "," ws
                    "\\"subtype\\"" ws ":" ws "\\"" choice-subtype "\\"" ws "," ws
                    "\\"note\\"" ws ":" ws string
                  ws "}"
choice-subtype ::= "approval" | "override" | "rejection" | "constraint" | "inquiry"
method-mark   ::= "{" ws
                    "\\"type\\"" ws ":" ws "\\"method\\"" ws "," ws
                    "\\"subtype\\"" ws ":" ws "\\"" method-subtype "\\"" ws "," ws
                    "\\"note\\"" ws ":" ws string
                  ws "}"
